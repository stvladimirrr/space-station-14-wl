...
ent-PillCanister = баночка для таблеток
    ...
    .suffix = { "" }
ent-MedicalInjector = Медицинский инъектор
    .desc = Довольно продвинутый способ ввода препаратов в кровь организмов, быстрее шприца, но дешевле Гипоспрея, из-за чего его популярность и массовость только возрастала.
    .suffix = { "" }
